...
//	@JsonBackReference
	...
	public static class PriceComponent {
		...
		public String toString() {
			return "PriceComponent [sellingPrice=" + sellingPrice + ", totalPrice=" + totalPrice + ", shippingCharge="
					+ shippingCharge + ", customerPrice=" + customerPrice + ", mercuiusDiscount=" + mercuiusDiscount
					+ "]";
		}
	...
	public String toString() {
		return "OrderItem [orderItemId=" + orderItemId + ", order=" + order + ", cart=" + cart + ", accountId="
				...
				+ ", priceComponents=" + priceComponents.toString() + ", isReplacement=" + isReplacement + ", productId="
				+ productId + "]";
	}
